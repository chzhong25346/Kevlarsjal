...
if __name__ == '__main__':
    ...
    group.add_argument("-s", "--simulation",help="Simulation",action="store_true")
    ...
    if(args.all):
        ...
        logger.debug('simulating trading.. %s %s %s %s', index_name,indCode,type,intraday)
        simulating(index_name,indCode,intraday,type)
